...
public class KafkaUnit {
    ...
    public void startup() {
        zookeeperEmbedded = new ZookeeperEmbedded(zkPort);
        zookeeperEmbedded.startup();
    ...
    public void _createTopic(String topicName, Integer numPartitions) {
    ...
    public void createTopic(String topicName, int numPartitions, int replication, Properties topicConfig) {
        ...
        ZkUtils zkUtils = new ZkUtils(
            zkClient,
            new ZkConnection(zookeeperString),
            false);
    ...
    public void shutdown() {
        ...
        if (zookeeperEmbedded != null) zookeeperEmbedded.shutdown();
    }
